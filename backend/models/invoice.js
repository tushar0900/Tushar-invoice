...
const brandingSchema = new mongoose.Schema(
  {
    ...
    accent: {
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.accent,
    },
    accentStrong: {
      type: String,
      required: true,
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.accentStrong,
    },
    background: {
      type: String,
      required: true,
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.background,
    },
    border: {
      type: String,
      required: true,
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.border,
    },
    bannerStart: {
      type: String,
      required: true,
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.bannerStart,
    },
    bannerEnd: {
      type: String,
      required: true,
      ...
      uppercase: true,
      match: /^#[0-9A-F]{6}$/,
      default: defaultBranding.bannerEnd,
    },
  },
  { _id: false }
);
